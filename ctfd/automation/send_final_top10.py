...
GMAIL_USER = "g1014308@gmail.com"
GMAIL_APP_PASS = "YOUR_GMAIL_APP_PASSWORD_HERE"
ADMIN_EMAIL = "g1014308@gmail.com"
...
def main():
    ...
    for w in winners:
        ...
        subject = f"【中央資管 Mini-CTF】恭喜破關！榮登 TOP 10 ☕"
        ...
        try:
            ...
            sent_summary.append(f"❌ Rank {rank}: {name} ({score} 分) -> {email} (Error: {e})")
