...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 27** | MSF / Chisel 搭建 SOCKS5 代理隧道與 Pivoting 內網穿透 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 29** | 黑盒 VulnHub 靶機 (Os-hackNos) 資訊收集與 Nmap 服務掃描 | 按專題課後練習進度 |
| **Day 30** | 靶機漏洞組合利用、獲取 Root 權限與 Writeup 撰寫 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 35** | Sqlmap `-r req.txt`, `--level 5 --risk 3`, `--os-shell` 抓包拖庫參數 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 47** | Linux 內核溢出漏洞利用 (Dirty COW 臟牛, PTRACE_TRACEME) | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 49** | Windows Server 2008R2 溢出提權與 LPK 劫持提權 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 57** | AWVS 14 漏洞自動化掃描器配置與黑盒主動掃描 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 59** | YXCMS 1.4.7 離線靶場部署與黑盒滲透測試 | 按專題課後練習進度 |
| **Day 60** | WordPress 綜合檢測與 Month 2 階段 Writeup 總結 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 65** | 格式化字串漏洞 (`printf`) 記憶體洩露原理 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 71** | Nmap 內網 C 段主機存活探測 (`nmap -sn`) 與服務識別 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 73** | Pass-the-Hash (哈希傳遞) 攻擊與 Mimikatz 抓取 NTLM Hash | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 75** | Cobalt Strike Teamserver 搭建與 Client 連線 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 77** | Active Directory 域控架構與 Kerberos 認證流程 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 79** | Golden Ticket (黃金票據) 偽造與 `krbtgt` Hash 控制域控 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 81** | 免殺技術：Shellcode Loader 異或 / AES 特徵加密解密 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 83** | Linux 權限維持：SSH 公鑰寫入、Crontab 定時任務與 SUID 後門 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 85** | MSF `msfvenom` 生成 Payload 與 Handler 監聽設定 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 87** | 攻擊痕跡清理：Linux 命令歷史 (`history -c`) 與 Windows 事件日誌 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 89** | 內網 AD 靶場：Web 入口點突破 ➔ SOCKS5 代理穿透進入內網 | 按專題課後練習進度 |
| **Day 90** | 橫向移動至域控 (DC) 獲取 Domain Admin 與 Writeup 撰寫 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 95** | YXCMS 1.4.7 解包、路由解析與 SQL 查詢構造器白箱分析 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 99** | Apache / Nginx Access Log 剖析與 Web 攻擊特徵日誌搜尋 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 101** | SIEM 概念與 ELK (Elasticsearch, Logstash, Kibana) 集中日誌 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 103** | Windows 事件檢視器關鍵 Event ID (4624, 4625, 4672) 判讀 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 107** | 藍隊資安事件應變處置 (IR) 標準流程 (準備 ➔ 檢測 ➔ 根除) | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 115** | TCP/IP 三向交握、TLS 1.3 握手流程、HTTP 狀態碼筆試題 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 117** | 滲透測試項目經歷 STAR 原則描述與漏洞復盤表達 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 119** | 從代碼審計 ➔ 部署 WAF SecRule 擋截 ➔ SIEM 日誌告警 | 按專題課後練習進度 |
| **Day 120** | 產出藍隊防禦加固報告、代碼修補建議書與 Writeup 總結 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 121** | DMZ 邊界網路探測、Nmap 服務指紋識別與入口點掃描 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 123** | Chisel / MSF 搭建 SOCKS5 代理與二階內網隧道穿透 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 125** | Pass-the-Hash (哈希傳遞) 橫向移動至內網成員伺服器 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 127** | Kerberoasting 攻擊與 SPN 服務帳號離線 Hash 爆破 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 129** | 企業紅隊攻防成果整理、戰果日誌與攻擊路徑拓撲圖繪製 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 131** | AWD 戰前準備：SSH 密碼修改、GameBox 源碼備份與權限檢查 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 133** | 部署 AWD 流量監控被動式 WAF 腳本與全網抓包日誌記錄 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 135** | 開發 Python AWD 批量抓 Flag 腳本與 API 自動提交 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 137** | 應對對手修補：撰寫二階 POP 鏈與混淆繞過 Exp 攻破對手 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 139** | 參加 2 小時實時模擬 AWD 攻防對抗賽（攻防實時交鋒） | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 149** | 漏洞重現 Writeup 整理、PoC/Exp 代碼庫維護與驗證 | 按專題課後練習進度 |
| **Day 150** | Month 5 階段考核總結、CVE 防禦修補建議書產出 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 151** | 藍隊 SOC 資安事件應變 (IR) 啟動：受害主機隔離與封包保存 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 153** | 利用 Volatility 分析受害主機記憶體 Dump，還原惡意進程 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 155** | 排查受害主機後門（Autoruns 機碼、排程工作與服務） | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 157** | 從離線快照與安全備份中還原資料庫與系統服務 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 159** | 撰寫 SOC 藍隊事件應變處置與鑑識報告 (IR Report) | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 161** | 終極考核（紅隊）：VulnHub 離線靶機黑盒資訊收集與服務掃描 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 163** | 終極考核（紅隊）：Linux SUID / Kernel 提權獲取 Root 權限 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 165** | 終極考核（藍隊）：代碼白箱審計與漏洞源碼修補 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 167** | 終極考核（藍隊）：Windows/Linux 系統安全加固與帳號審查 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 169** | 紅藍攻防結果對比、同儕互審與攻防路徑復盤 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 171** | 整理 6 個月 Writeup 專案庫與 Markdown 整理編排 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 173** | 資安工程師履歷撰寫與項目經歷 STAR 原則包裝 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 175** | 資安面試 HR 綜合面試題與團隊協作問答演練 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 177** | 讀書會結業專題成果實機演示 (Live Demo) 預演 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日學習重點 (Focus Task) | 🧪 指定練習關卡 (Lab / Challenge) |
| :--- | :--- | :--- |
| **Day 179** | 6 個月讀書會成長復盤與頒發結業證書 | 按專題課後練習進度 |
| **Day 180** | 圓滿結業與資安求職正式啟航 | 按專題課後練習進度 |