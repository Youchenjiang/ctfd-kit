...
| :--- | :--- | :--- | :--- |
| **Day 1** (08/07) | HTTP 請求與回應標頭分析 (GET/POST/Header/Status Code) | 📁 [`01_Web安全/02_HTTP協定與代理抓包`](../../../../01_Web安全/02_HTTP協定與代理抓包) <br>🎥 觀看抓包教學影片 | 🎯 **必解關卡**:<br>🚩 **picoCTF**: • [Insp3ct0r (ID: 367)](https://learn.cylabacademy.org/library?search=Insp3ct0r)<br>🌐 **PortSwigger**: • [Lab: Intercepting Web Requests via Burp](https://portswigger.net/burp)<br>🚀 **延伸挑戰**:<br>🚩 **picoCTF**: • [what's a net cat? (ID: 156)](https://learn.cylabacademy.org/library?search=what%27s%20a%20net%20cat%3F)<br>• [Super SSH (ID: 424)](https://learn.cylabacademy.org/library?search=Super%20SSH)<br>🌐 **PortSwigger**: • [Lab: Modifying Web Requests](https://portswigger.net/burp/proxy) |
| **Day 2** (08/08) | Burp Suite 代理截獲、Repeater 重放與 POST 欄位修改 | 📁 [`01_Web安全/02_HTTP協定與代理抓包`](../../../../01_Web安全/02_HTTP協定與代理抓包) <br>🎥 觀看抓包教學影片 | 同 Day 1 關卡（延續實操與延伸挑戰） |
...
| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 5** (08/11) | OS 命令注入原理與 Linux/Windows 命令拼接符 (` ; `, ` & `, ` && `, ` \| `, ` \|\| `) | 📁 [`01_Web安全/07_RCE命令與代碼執行`](../../../../01_Web安全/07_RCE命令與代碼執行) | 🎯 **必解關卡**:<br>🚩 **picoCTF**: • [ping-cmd (ID: 757)](https://learn.cylabacademy.org/library?search=ping-cmd)<br>🌐 **PortSwigger**: • [Lab: OS command injection, simple case](https://portswigger.net/web-security/os-command-injection/lab-simple)<br>🚀 **延伸挑戰**:<br>🌐 **PortSwigger**: • [Lab: File path traversal, simple case](https://portswigger.net/web-security/file-path-traversal/lab-simple)<br>💡 **帶練指引**: 講解 Linux 命令拼接符 `; & && \| \|\|` 差異與 ping-cmd 實操 |
| **Day 6** (08/12) | 路徑遍歷 (Path Traversal) 與 `../` 讀取 `/etc/passwd` | 📁 [`01_Web安全/07_RCE命令與代碼執行`](../../../../01_Web安全/07_RCE命令與代碼執行) | [PortSwigger: Path Traversal Simple](https://portswigger.net/web-security/file-path-traversal/lab-simple)<br>💡 **帶練指引**: 講解 Linux 命令拼接符 `; & && \| \|\|` 差異並提供 RCE 測試腳本 |
...
| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 7** (08/13) | Wireshark 基礎介面、網路介面選擇與網絡卡混雜模式捕獲 | 📁 [`01_影片教學`](../../../../06_網路安全與數位取證/03_流量分析PCAP/Wireshark專題_流量監聽與分析/01_影片教學) <br>🎥 `1-WireShark简介和抓包原理及过程.mp4` ~ `3-WireShark的过滤器使用.mp4`<br>📄 帶練講義 [`WireShark操作練習-2024.docx`](../../../../06_網路安全與數位取證/03_流量分析PCAP/Wireshark專題_流量監聽與分析/02_帶練講義與PCAP實戰/WireShark操作練習-2024.docx) | 🎯 **必解關卡**:<br>🚩 **picoCTF**: • [Wireshark doo dooo do doo... (ID: 432)](https://learn.cylabacademy.org/library?search=Wireshark%20doo%20dooo%20do%20doo...)<br>🚀 **延伸挑戰**:<br>🚩 **picoCTF**: • [Trivial Flag Transfer Protocol (ID: 434)](https://learn.cylabacademy.org/library?search=Trivial%20Flag%20Transfer%20Protocol) |
| **Day 8** (08/14) | Wireshark 顯示過濾語法 (`ip.addr`) 與 HTTP 追蹤流分析 | 📁 [`02_帶練講義與PCAP實戰`](../../../../06_網路安全與數位取證/03_流量分析PCAP/Wireshark專題_流量監聽與分析/02_帶練講義與PCAP實戰) <br>🎥 `6-TCP协议.mp4` ~ `8-实战：WireShark抓包解决服务器被黑问题.mp4`<br>🧪 分析本地封包 [`SQLInjection.pcapng`](../../../../06_網路安全與數位取證/03_流量分析PCAP/Wireshark專題_流量監聽與分析/02_帶練講義與PCAP實戰/SQLInjection.pcapng) | 同 Day 7 關卡（延續實操與延伸挑戰） |
...
| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 9** (08/15) | 任意檔案上傳原理、前端 JS 驗證繞過與 Content-Type 偽造 | 📁 [`01_影片教學/01_檔案上傳漏洞原理與繞過`](../../../../01_Web安全/08_檔案上傳與Webshell木馬權維/01_影片教學/01_檔案上傳漏洞原理與繞過) <br>📄 講義 [`02_帶練講義與PPT簡報/01_檔案上傳繞過全套PPT`](../../../../01_Web安全/08_檔案上傳與Webshell木馬權維/02_帶練講義與PPT簡報/01_檔案上傳繞過全套PPT) | 🎯 **必解關卡**:<br>🌐 **PortSwigger**: • [Lab: Remote code execution via web shell upload](https://portswigger.net/web-security/file-upload/lab-file-upload-remote-code-execution-via-web-shell-upload) |
| **Day 10** (08/16) | 一句話木馬編寫與中國蟻劍 (AntSword) 連線 Webshell | 📁 [`04_Webshell管理工具箱/01_中國蟻劍_AntSword`](../../../../01_Web安全/08_檔案上傳與Webshell木馬權維/04_Webshell管理工具箱/01_中國蟻劍_AntSword) <br>📦 樣本庫 [`03_Webshell木馬樣本庫/PHP木馬與大馬`](../../../../01_Web安全/08_檔案上傳與Webshell木馬權維/03_Webshell木馬樣本庫/PHP木馬與大馬) | 同 Day 9 關卡（延續實操與延伸挑戰） |
...
| :--- | :--- | :--- | :--- |
| **Day 13** (08/19) | HITCON 2026 Wargame 賽事實戰衝刺（Web / Pwn / Reverse / Crypto 題型突破） | 📁 賽事專題庫 [`HITCON_2026_Wargame`](../../../../08_通用學習與面試庫/01_CTF競賽Writeup與題解/HITCON_2026_Wargame) | 🎯 **實戰任務**:<br>🚩 **HITCON Wargame**: • 全隊衝刺解題，即時記錄解題封包與卡關點 |
| **Day 14** (08/20) | 賽後 Writeup 整理、官方題解覆盤與全領域盲點歸納 | 📄 撰寫覆盤 [`HITCON_2026_賽後覆盤與Writeup模板.md`](../../../../08_通用學習與面試庫/01_CTF競賽Writeup與題解/HITCON_2026_Wargame/HITCON_2026_賽後覆盤與Writeup模板.md) | 🎯 **覆盤任務**:<br>📝 提交個人 Writeup 並對照官方題解還原 Root Cause |
...
| :--- | :--- | :--- | :--- |
| **Day 15** (08/21) | XSS 跨站腳本成因、Reflected / Stored / DOM XSS 與 Cookie 竊取 | 📁 研讀速查指南 [`00_XSS跨站腳本實戰速查手冊_中文版.md`](../../../../01_Web安全/10_客戶端與業務邏輯漏洞/01_XSS跨站腳本挖掘與攻擊/00_XSS跨站腳本實戰速查手冊_中文版.md) <br>📄 閱讀講義 PDF [`第三章（2）：反射型XSS漏洞原理.pdf`](../../../../01_Web安全/10_客戶端與業務邏輯漏洞/01_XSS跨站腳本挖掘與攻擊/第三章（2）：反射型XSS漏洞原理.pdf) ~ [`第三章（4）：DOM型XSS漏洞.pdf`](../../../../01_Web安全/10_客戶端與業務邏輯漏洞/01_XSS跨站腳本挖掘與攻擊/第三章（4）：DOM型XSS漏洞.pdf)<br>📊 參閱講義 PPT [`第一節 XSS跨站腳本分類-01.pptx`](../../../../01_Web安全/10_客戶端與業務邏輯漏洞/01_XSS跨站腳本挖掘與攻擊/第一節%20XSS跨站腳本分類-01.pptx) ＋ [`第二節 XSS盜取cookie-01.pptx`](../../../../01_Web安全/10_客戶端與業務邏輯漏洞/01_XSS跨站腳本挖掘與攻擊/第二節%20XSS盜取cookie-01.pptx) | 🎯 **必解關卡**:<br>🌐 **PortSwigger**: • [Lab: Reflected XSS into HTML context](https://portswigger.net/web-security/cross-site-scripting/reflected/lab-html-context-nothing-encoded)<br>🚀 **延伸挑戰**:<br>🌐 **PortSwigger**: • [Lab: Stored XSS into anchor href](https://portswigger.net/web-security/cross-site-scripting/stored/lab-html-context-nothing-encoded)<br>• [Lab: CORS with basic origin reflection](https://portswigger.net/web-security) |
| **Day 16** (08/22) | CSRF 跨站請求偽造原理、PoC 自動提交表單與 Token 防禦 | 📁 研讀速查指南 [`00_CSRF跨站請求偽造實戰速查手冊_中文版.md`](../../../../01_Web安全/10_客戶端與業務邏輯漏洞/02_CSRF跨站請求偽造/00_CSRF跨站請求偽造實戰速查手冊_中文版.md) <br>📄 閱讀講義 PDF [`第三章（7）：CSRF跨站请求伪造漏洞原理、攻击演练.pdf`](../../../../01_Web安全/10_客戶端與業務邏輯漏洞/02_CSRF跨站請求偽造/第三章（7）：CSRF跨站请求伪造漏洞原理、攻击演练.pdf)<br>📊 參閱講義 PPT [`第一節 CSRF原理介紹-01.pptx`](../../../../01_Web安全/10_客戶端與業務邏輯漏洞/02_CSRF跨站請求偽造/第一節%20CSRF原理介紹-01.pptx) ＋ [`第二節 無防護的CSRF漏洞利用-01.pptx`](../../../../01_Web安全/10_客戶端與業務邏輯漏洞/02_CSRF跨站請求偽造/第二節%20無防護的CSRF漏洞利用-01.pptx) | 🎯 **必解關卡**:<br>🌐 **PortSwigger**: • [Lab: CSRF vulnerability with no defenses](https://portswigger.net/web-security/csrf/lab-no-defenses) |
...
| :--- | :--- | :--- | :--- |
| **Day 17** (08/25) | 逆向工程導論、靜態分析概念與 PE / ELF 可執行檔結構 | 📁 研讀通關手冊 [`00_Ghidra與IDA_Pro靜態逆向工程實戰通關手冊_中文版.md`](../../../../02_二進制與逆向/02_靜態反彙編與動態逆向/00_Ghidra與IDA_Pro靜態逆向工程實戰通關手冊_中文版.md) <br>📄 閱讀講義 PDF [`4.1 ToolTypes.pdf`](../../../../02_二進制與逆向/02_靜態反彙編與動態逆向/4.1%20ToolTypes.pdf) ＋ [`4.3 ToolGuides.pdf`](../../../../02_二進制與逆向/02_靜態反彙編與動態逆向/4.3%20ToolGuides.pdf) | 🎯 **必解關卡**:<br>🚩 **picoCTF**: • [Safe Opener 1 (ID: 513)](https://learn.cylabacademy.org/library?search=Safe%20Opener%201) & [Safe Opener 2 (ID: 515)](https://learn.cylabacademy.org/library?search=Safe%20Opener%202)<br>🚀 **延伸挑戰**:<br>🚩 **picoCTF**: • [vault-door-training (ID: 472)](https://learn.cylabacademy.org/library?search=vault-door-training) |
| **Day 18** (08/26) | Ghidra / IDA Pro 反編譯 C 虛擬碼與 Serial 驗證邏輯逆向 | 📄 閱讀講義 PDF [`5.3 HelloWorld.pdf`](../../../../02_二進制與逆向/02_靜態反彙編與動態逆向/5.3%20HelloWorld.pdf) ＋ [`5.4 Loops.pdf`](../../../../02_二進制與逆向/02_靜態反彙編與動態逆向/5.4%20Loops.pdf) | 同 Day 17 關卡（延續實操與延伸挑戰） |
...
| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 23** (08/31) | Flask Jinja2 SSTI 原理與 `{{config}}` / `__class__` 變數洩露 | 📁 研讀通關手冊 [`00_SSTI模板注入與反序列化漏洞實戰通關手冊_中文版.md`](../../../../01_Web安全/11_反序列化與組件漏洞/00_SSTI模板注入與反序列化漏洞實戰通關手冊_中文版.md) <br>🎥 觀看教學影片 [`8-1 Flask框架介绍与基础.mp4`](../../../../01_Web安全/11_反序列化與組件漏洞/04_SSTI模板注入(Flask_Jinja2)/8-1%20Flask%E6%A1%86%E6%9E%B6%E4%BB%8B%E7%BB%8D%E4%B8%8E%E5%9F%BA%E7%A1%80.mp4) ＋ [`8-2 SSTI注入利用（RCE 文件读写）.mp4`](../../../../01_Web安全/11_反序列化與組件漏洞/04_SSTI模板注入(Flask_Jinja2)/8-2%20SSTI%E6%B3%A8%E5%85%A5%E5%88%A9%E7%94%A8%EF%BC%88RCE%20%E6%96%87%E4%BB%B6%E8%AF%BB%E5%86%99%EF%BC%89.mp4) | 🎯 **必解關卡**:<br>🌐 **PortSwigger**: • [Lab: Basic server-side template injection (ERB)](https://portswigger.net/web-security/server-side-template-injection/exploiting/lab-server-side-template-injection-basic)<br>🚀 **延伸挑戰**:<br>🌐 **PortSwigger**: • [Lab: Basic SSTI in Tornado](https://portswigger.net/web-security/server-side-template-injection/exploiting/lab-server-side-template-injection-basic-tornado) |
| **Day 24** (09/01) | PHP 魔術方法 `__wakeup()` 觸發與 Java 物件反序列化 | 🎥 觀看教學影片 [`7-1 序列化和反序列化介绍.mp4`](../../../../01_Web安全/11_反序列化與組件漏洞/01_PHP反序列化與魔術方法/7-1%20%E5%BA%8F%E5%88%97%E5%8C%96%E5%92%8C%E5%8F%8D%E5%BA%8F%E5%88%97%E5%8C%96%E4%BB%8B%E7%BB%8D.mp4) ＋ [`7-4 PHP序列化 - 魔术方法.mp4`](../../../../01_Web安全/11_反序列化與組件漏洞/01_PHP反序列化與魔術方法/7-4%20PHP%E5%BA%8F%E5%88%97%E5%8C%96%20-%20%E9%AD%94%E6%9C%AF%E6%96%B9%E6%B3%95.mp4)<br>📁 測試本地工具 [`Java反序列化终极测试工具.jar`](../../../../01_Web安全/11_反序列化與組件漏洞/03_Java反序列化漏洞/Java反序列化终极测试工具.jar) | 🎯 **必解關卡**:<br>🌐 **PortSwigger**: • [Lab: Modifying serialized objects](https://portswigger.net/web-security/deserialization/exploiting/lab-deserialization-modifying-serialized-objects)<br>🚀 **延伸挑戰**:<br>🌐 **PortSwigger**: • [Lab: Modifying serialized data types](https://portswigger.net/web-security/deserialization/exploiting/lab-deserialization-modifying-serialized-data-types) |
...
| **Day 36** | `mysqldump` 資料庫備份與 MySQL UDF (`sys_eval`) 特權執行 | 📁 [`01_Web安全/06_SQL注入漏洞專題`](../../../../01_Web安全/06_SQL注入漏洞專題) <br>🎥 觀看 SQL 注入基礎影片 | 同 Day 33 關卡（延續實操與延伸挑戰） |
...
| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 37** | Sqlmap `-r req.txt`, `--level 5 --risk 3`, `--os-shell` 抓包拖庫引數 | 🎥 觀看 [`10.8MYSQLUDF提权与命令执行.mp4`](../../../../01_Web安全/06_SQL注入漏洞專題/07_SQL注入WAF繞過與拖庫/10.8MYSQLUDF提权与命令执行.mp4) | 按專題課後練習進度 |
...
| **Day 44** | 前端 JS 混淆程式碼逆向與 Chrome DevTools 中斷點除錯解密 | 📁 解析本地 HTML [`exam.html`](../../../../01_Web安全/01_前端語言與語法/05_JS加密解密與前端解題/exam.html) | 同 Day 41 關卡（延續實操與延伸挑戰） |
...
| **Day 48** | JSONP 跨域資料劫持與 CORS 跨域資源共享配置缺陷利用 | 📁 解析本地 HTML [`exam.html`](../../../../01_Web安全/01_前端語言與語法/05_JS加密解密與前端解題/exam.html) | 同 Day 45 關卡（延續實操與延伸挑戰） |
...
| **Day 54** | PHPGGC 自動化 Payload 生成器與 Phar 反序列化利用 | 📁 測試本地工具 [`Java反序列化终极测试工具.jar`](../../../../01_Web安全/11_反序列化與組件漏洞/03_Java反序列化漏洞/Java反序列化终极测试工具.jar) | 同 Day 51 關卡（延續實操與延伸挑戰） |
...
| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 55** | Java `readObject()` 漏洞成因、ysoserial 工具與 CC 鏈分析 | 📁 測試本地工具 [`Java反序列化终极测试工具.jar`](../../../../01_Web安全/11_反序列化與組件漏洞/03_Java反序列化漏洞/Java反序列化终极测试工具.jar) | 🎯 **必解關卡**:<br>🌐 **PortSwigger**: • [Lab: Exploiting Java deserialization with Apache Commons](https://portswigger.net/web-security/deserialization/exploiting/lab-deserialization-exploiting-java-deserialization-with-apache-commons) |
...
| **Day 60** | Burp Suite + Xray 被動式掃描器代理聯動挖掘 | 📁 [`01_Web安全/02_HTTP協定與代理抓包`](../../../../01_Web安全/02_HTTP協定與代理抓包) <br>🎥 觀看抓包教學影片 | 按專題課後練習進度 |
...
| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 61** | YXCMS 1.4.7 離線靶場部署與黑盒滲透測試 | 📁 解壓本地靶場 [`YXCMS.zip`](../../../../01_Web安全/14_綜合靶場與VulnHub實戰演練/02_CMS實務靶場環境/YXCMS.zip) | 按專題課後練習進度 |
| **Day 62** | WordPress 綜合檢測與 Month 2 階段 Writeup 總結 | 📁 解壓本地靶場 [`YXCMS.zip`](../../../../01_Web安全/14_綜合靶場與VulnHub實戰演練/02_CMS實務靶場環境/YXCMS.zip) | 按專題課後練習進度 |
...
| **Day 74** | fscan 自動化內網掃描與弱口令爆破 (SSH, RDP, MySQL) | 📁 [`01_Web安全/06_SQL注入漏洞專題`](../../../../01_Web安全/06_SQL注入漏洞專題) <br>🎥 觀看 SQL 注入基礎影片 | 按專題課後練習進度 |
...
| **Day 82** | Silver Ticket (白銀票據) 偽造與 MSSQL / CIFS 服務切入 | 📁 [`01_Web安全/06_SQL注入漏洞專題`](../../../../01_Web安全/06_SQL注入漏洞專題) <br>🎥 觀看 SQL 注入基礎影片 | 按專題課後練習進度 |
...
> [!NOTE]
> **組長備註 (教材規劃儲備)**：本目錄已建立完整規格指南 [`README.md`](../../../../04_系統與內網安全/10_免殺技術與EDR繞過/README.md)（涵蓋 Shellcode Loader、AMSI 繞過與直接系統呼叫 Syscalls 架構），後續將規劃補充實戰 PoC 與載入器腳本。

| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 83** | 免殺技術：Shellcode Loader 異或 / AES 特徵加密解密 | 📁 參閱規格指南 [`README.md`](../../../../04_系統與內網安全/10_免殺技術與EDR繞過/README.md) | 按專題課後練習進度 |
| **Day 84** | 利用 Windows API (`VirtualAlloc`, `RtlMoveMemory`) 繞過記憶體掃描 | 📁 參閱規格指南 [`README.md`](../../../../04_系統與內網安全/10_免殺技術與EDR繞過/README.md) | 按專題課後練習進度 |
...
| **Day 94** | PHP 變數追蹤法 (Sinks to Sources) 與 SQLi / XSS 白箱發現 | 📁 [`01_Web安全/06_SQL注入漏洞專題`](../../../../01_Web安全/06_SQL注入漏洞專題) <br>🎥 觀看 SQL 注入基礎影片 | 同 Day 91 關卡（延續實操與延伸挑戰） |
...
| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 95** | Java Web 架構 (Filter, Servlet, Spring MVC) 與 Controller 入口 | 📁 測試本地工具 [`Java反序列化终极测试工具.jar`](../../../../01_Web安全/11_反序列化與組件漏洞/03_Java反序列化漏洞/Java反序列化终极测试工具.jar) | 🎯 **必解關卡**:<br>🌐 **PortSwigger**: • [PortSwigger Java Vulnerability Analysis](https://portswigger.net/web-security)<br>🚀 **延伸挑戰**:<br>🌐 **PortSwigger**: • [Source-to-Sink Data-flow Taint Analysis](https://portswigger.net/web-security) |
| **Day 96** | Java SQL 拼接 (MyBatis `${}` vs `#{}`) 與 `Runtime.exec()` RCE | 📁 [`01_Web安全/06_SQL注入漏洞專題`](../../../../01_Web安全/06_SQL注入漏洞專題) <br>🎥 觀看 SQL 注入基礎影片 | 同 Day 93 關卡（延續實操與延伸挑戰） |
...
| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 97** | YXCMS 1.4.7 解包、路由解析與 SQL 查詢構造器白箱分析 | 📁 [`01_Web安全/06_SQL注入漏洞專題`](../../../../01_Web安全/06_SQL注入漏洞專題) <br>🎥 觀看 SQL 注入基礎影片 | 按專題課後練習進度 |
| **Day 98** | YXCMS 前臺 SQL 注入與後臺寫入 GetShell 驗證與 0day 挖掘 | 📁 [`01_Web安全/06_SQL注入漏洞專題`](../../../../01_Web安全/06_SQL注入漏洞專題) <br>🎥 觀看 SQL 注入基礎影片 | 按專題課後練習進度 |
...
> [!NOTE]
> **組長備註 (教材規劃儲備)**：本目錄已建立完整規格指南 [`README.md`](../../../../06_網路安全與數位取證/07_惡意程式分析與沙箱/README.md)（涵蓋 PE 特徵分析、YARA 規則與動態沙箱 SOP），後續將規劃補充實戰分析腳本與 YARA 規則庫。

| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 109** | 藍隊資安事件應變處置 (IR) 標準流程 (準備 ➔ 檢測 ➔ 根除) | 📁 參閱規格指南 [`README.md`](../../../../06_網路安全與數位取證/07_惡意程式分析與沙箱/README.md) | 按專題課後練習進度 |
| **Day 110** | 惡意程序與後門排查工具 (Process Hacker, TCPView, Autoruns) | 📁 參閱規格指南 [`README.md`](../../../../06_網路安全與數位取證/07_惡意程式分析與沙箱/README.md) | 按專題課後練習進度 |
...
| **Day 116** | 撰寫自訂 SecRule 規則防禦 SQLi, XSS 與 RCE 命令執行 | 📁 [`01_Web安全/06_SQL注入漏洞專題`](../../../../01_Web安全/06_SQL注入漏洞專題) <br>🎥 觀看 SQL 注入基礎影片 | 同 Day 113 關卡（延續實操與延伸挑戰） |
...
| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 117** | TCP/IP 三向交握、TLS 1.3 握手流程、HTTP 狀態碼筆試題 | 📁 [`01_Web安全/02_HTTP協定與代理抓包`](../../../../01_Web安全/02_HTTP協定與代理抓包) <br>🎥 觀看抓包教學影片 | 按專題課後練習進度 |
...
| **Day 124** | Web 漏洞組合利用 (SQLi/Upload) 獲取 DMZ Web 殼許可權 | 📁 [`01_Web安全/06_SQL注入漏洞專題`](../../../../01_Web安全/06_SQL注入漏洞專題) <br>🎥 觀看 SQL 注入基礎影片 | 按專題課後練習進度 |
...
| **Day 134** | Web 原始碼漏洞修補：SQL 注入與 RCE 危險函式快速過濾 | 📁 [`01_Web安全/06_SQL注入漏洞專題`](../../../../01_Web安全/06_SQL注入漏洞專題) <br>🎥 觀看 SQL 注入基礎影片 | 按專題課後練習進度 |
...
| **Day 140** | GameBox 徹底清查：隱藏 Webshell、Cron 後門與不死馬清除 | 📁 [`01_Web安全/08_檔案上傳與包含漏洞`](../../../../01_Web安全/08_檔案上傳與包含漏洞) | 按專題課後練習進度 |
...
> [!NOTE]
> **組長備註 (教材規劃儲備)**：本主題除傳統框架 CVE 外，亦對接 [`11_雲端安全與容器逃逸/README.md`](../../../../04_系統與內網安全/11_雲端安全與容器逃逸/README.md)（涵蓋 AWS IMDS、Docker `--privileged` 與 K8s 提權），後續將規劃補充容器逃逸演練腳本。

| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 145** | Apache Shiro (CVE-2016-4437) RememberMe 反序列化重現 | 📁 測試本地工具 [`Java反序列化终极测试工具.jar`](../../../../01_Web安全/11_反序列化與組件漏洞/03_Java反序列化漏洞/Java反序列化终极测试工具.jar) | 🎯 **必解關卡**:<br>🚩 **picoCTF**: • [Clouds (ID: 288)](https://learn.cylabacademy.org/library?search=Clouds)<br>🌐 **PortSwigger**: • [Lab: HTTP request smuggling, basic CL.TE vulnerability](https://portswigger.net/web-security/request-smuggling/lab-basic-cl-te)<br>🚀 **延伸挑戰**:<br>🚩 **picoCTF**: • [SaaS (ID: 312)](https://learn.cylabacademy.org/library?search=SaaS) / [zero_to_hero (ID: 323)](https://learn.cylabacademy.org/library?search=zero_to_hero)<br>🌐 **PortSwigger**: • [Lab: HTTP request smuggling, basic TE.CL vulnerability](https://portswigger.net/web-security/request-smuggling/lab-basic-te-cl) |
| **Day 146** | ThinkPHP 5.0.23 5.1.x 容器注入 RCE 漏洞分析與驗證 | 📁 參閱容器安全指南 [`README.md`](../../../../04_系統與內網安全/11_雲端安全與容器逃逸/README.md) | 同 Day 143 關卡（延續實操與延伸挑戰） |
...
| **Day 156** | Wireshark 分析勒索軟體 C2 通訊流量與可疑外聯 IP | 📁 分析本地封包 [`SQLInjection.pcapng`](../../../../06_網路安全與數位取證/01_網路協定分析與Scapy/網路指令/SQLInjection.pcapng) | 按專題課後練習進度 |
...
> [!NOTE]
> **組長備註 (教材規劃儲備)**：對接 [`07_惡意程式分析與沙箱/README.md`](../../../../06_網路安全與數位取證/07_惡意程式分析與沙箱/README.md)（含 YARA 規則與後門特徵排查），後續將規劃補充樣本特徵與自動化查殺腳本。

| 天數 (Day) | 🎯 當日教學重點 (Focus Task) | 📁 本地影片/檔案與 🌐 線上資源 | 🧪 指定練習與帶練講義/PoC 腳本 (Instructor Walkthrough & Labs) |
| :--- | :--- | :--- | :--- |
| **Day 157** | 排查受害主機後門（Autoruns 機碼、排程工作與服務） | 📁 參閱規格指南 [`README.md`](../../../../06_網路安全與數位取證/07_惡意程式分析與沙箱/README.md) | 按專題課後練習進度 |
| **Day 158** | 根除木馬後門、更新防毒特徵碼與修補漏洞防護 | 📁 參閱規格指南 [`README.md`](../../../../06_網路安全與數位取證/07_惡意程式分析與沙箱/README.md) | 按專題課後練習進度 |
